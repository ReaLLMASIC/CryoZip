...
for d in code_distances:
    for max_nz_distance in max_nz_distances:
        for e in error_rates:
            ...
            with open(input_filename, 'r') as f:
                for batch in range(num_batches):
                    ...
                    max_nz_distances_len = len(nz_distances) if len(nz_distances)>max_nz_distances_len else max_nz_distances_len   
            ...
            print(f"max sparse distances output len{max_nz_distances_len}")

            output_filename = os.path.join(output_dirname, f"sparse_distance_huff_{max_nz_distance}.out")
            bits_filename = os.path.join(output_dirname, f"bits_sparse_distance_huff_{max_nz_distance}.out")
